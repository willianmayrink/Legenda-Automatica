...
for elem in Floors:
	if(elem.GetParameters("Height Offset From Level")[0].AsDouble()*30.48 != 0):
		desniveis.append((elem.GetParameters("Height Offset From Level")[0].AsDouble()*30.48,"LAJE"))
...
for elem in Beams:
	if(elem.GetParameters("z Offset Value")[0].AsDouble()*30.48!=0):
		desniveis.append((elem.GetParameters("z Offset Value")[0].AsDouble()*30.48,"VIGA"))
